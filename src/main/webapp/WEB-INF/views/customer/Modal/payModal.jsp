	...
	<div class="payMentListModalBody">
		...
		<div class="payMentmodalMainContent">
			...
			<div class="payMentContentRight">
				<!-- Content 1번째 라인 -->
				<div><input id="foCode" type="text" name="fo_code" readonly /><!-- 최종주문번호 --></div>
				<!-- Content 2번째 라인 -->
				<div>
					<div>
					...
					<div>
						<select class="cateSecond" disabled="disabled">
							<!-- 상품 카테고리 1 -->
							<option>롤케이크</option>
							<option>버터크림빵</option>
							<option>마늘빵</option>
				...
				<!-- Content 3번째 라인 -->
				<div>
					<div><input id="foCount" type="text" readonly /><!-- 수량 --></div><div>개</div>
					<div>주문 사이즈</div>
					<div><input id="foSize" type="text" readonly /><!-- 사이즈 --></div>
				</div>
				<!-- Content 4번째 라인 -->
				<div>
					<div><input id="foPrice" type="text" name="p_sum" readonly /><!-- 결제금액 --></div><div>원</div>
					<div>배송 형태</div>
					<div>
				...
				<!-- Content 5번째 라인 -->
				<div>
					<input id="payEtc" type="text" readonly />
					<!-- 요구사항 -->
				</div>
			</div>
		</div>
		...
		<div class="payMentsubtitle">
			<div>결제정보</div>
			<div>
				<a href="customerCard.do?id=<%=request.getParameter("id")%>"><input type="button" value="결제정보 수정하기" /></a>
			</div>
		</div>
		<hr />
		...
		<div class="payMentmodalMainContent2">
			...
			<div class="payMentContentRight2">
				<!-- Content 1번째 라인 -->
				<div>
					<select class="paySelect" name="pt_code">
						<!-- 결제방식 -->
				...
				<!-- Content 2번째 라인 -->
				<div>
					<div><input id="payMentPrice" type="text" readonly /><!-- 결제금액 --></div><div>원</div>
					<div>결제일자</div>
					<div><input id="payMentDate" type="text" name="p_date" readonly /><!-- 결제일자 --></div>
				</div>
			</div>
		</div>
		...
		<div class="payMentmodalMainContent3">
			...
			<div class="payMentContentRight3">
				<!-- Content 1번째 라인 -->
				<div><input id="deliName" name="d_name" type="text" required /><!-- 수령자명 --></div>
				<!-- Content 2번째 라인 -->
